...
@section('content')
    ...
    <div data-name="password_reset" class="page">
        ...
        <div class="page-content">
            <div class="block-footer margin-left margin-right text-align-center">
                <p>@lang('imrepo.reset_password_instruction')</p>
            </div>
            ...
            @endif
            <!-- Login form -->
            <form method="POST" class="form-ajax-submit" action="{{ route('customer.password.reset') }}">
                ...
                <div class="list margin-left margin-right ">
                    <button type="submit" class="list-button loginPageButtonStyle">@lang('imrepo.reset_password')</button>
                </div>
